...
squarePlane.position.set(-this.app.screen.width / 4, -this.app.screen.height / 2);
...
this.app.ticker.add((delta) => {
    const pos = container.toLocal(squareFar.position, undefined, undefined, undefined, TRANSFORM_STEP.BEFORE_PROJ);
