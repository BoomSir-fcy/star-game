              ...
              nav={[
                {
                  id: 0,
                  label: t('All'),
                  path: `/star/planet?t=0${
                    choose ? `&hide=true&choose=${choose}` : ''
                  }`,
                },
                {
                  id: 1,
                  label: t('rarity-1'),
                  path: `/star/planet?t=1${
                    choose ? `&hide=true&choose=${choose}` : ''
                  }`,
                },
                {
